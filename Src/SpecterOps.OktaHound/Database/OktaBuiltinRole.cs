...
public sealed class OktaBuiltinRole : OktaRole
{
    ...
    private OktaBuiltinRole() : base(string.Empty, string.Empty, string.Empty)
    {
    }

    public OktaBuiltinRole(IamRole role, string domainName) : base(MakeRoleIdUnique(role.Id, domainName), role.Label, domainName)
    {
    ...
    internal static string MakeRoleIdUnique(string roleId, string domainName)
    {
    ...
    {
        JsonSerializer.Serialize(writer, this, TestSerializationContext.Default.OktaBuiltinRole);
    }
}
