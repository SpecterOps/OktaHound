...
public class OktaGraphTester
{
    ...
    public void OktaGraph_Serialization_Empty()
    {
        ...
        Assert.AreEqual("{\"metadata\":{\"source_kind\":\"Okta\"},\"graph\":{\"nodes\":[{\"id\":\"abc\",\"properties\":{\"displayName\":\"Contoso\",\"name\":\"contoso.okta.com\",\"oktaDomain\":\"contoso.okta.com\"},\"kinds\":[\"OktaOrganization\"]}],\"edges\":[]}}", json);
    }
}
