...
The traversable `Okta_SecretOf` edges represent the relationship between service applications and their associated client secrets,
represented by the [Okta_ClientSecret](Okta_ClientSecret.md) nodes:
...
graph LR
    ...
    a1("Okta_Application OktaHound")
    a2("Okta_Application PurpleKnight")
    cs1 -- Okta_SecretOf --> a1
    cs2 -- Okta_SecretOf --> a2
    cs3 -- Okta_SecretOf --> a2
```
...
### Okta_ReadPasswordUpdates Edges
