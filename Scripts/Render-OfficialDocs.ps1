...
[string] $imagesOutputDir = Join-Path -Path $officialDocsDir -ChildPath 'images/extensions/OktaHound/reference'
...
& (Join-Path -Path $PSScriptRoot -ChildPath 'Render-Schema.ps1') -OutputPath $schemaOutputPath -NodeLinkBasePath 'nodes' -EdgeLinkBasePath 'edges' -IconBasePath '/images/extensions/OktaHound' -OfficialDocs
