...
if ($OfficialDocs) {
    ...
    [string] $extensionFilePath = 'https://github.com/SpecterOps/OktaHound/blob/main/Src/Extensions/bhce-okta-extension.json'
    [bool] $useMintlifyCallouts = $true
} else {
    [string] $linkExtension = '.md'
    [string] $extensionFilePath = '../Src/Extensions/bhce-okta-extension.json'
...
if ($useMintlifyCallouts) {
    $markdown += @'
<Info>
This file is automatically generated from the [bhce-okta-extension.json]({0}) file
